 ...
 * Cron route auth.
 *
 * The Worker's scheduled handler (worker.ts) sends
 * `Authorization: Bearer $CRON_SECRET` when it dispatches a cron run. The same
 * header lets you trigger a run by hand with curl.
 *
