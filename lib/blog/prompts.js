...
- Never write "research shows", "studies indicate", "experts agree" or "data suggests" without naming the specific source in the same sentence. Vague attribution reads as invented. Name it or drop it.
- Your OWN pricing is different and encouraged, but it must be unmistakably framed as ours. Write "we quote", "our range for this is", "what we charge" — never present our numbers as a market average or an industry statistic. An unattributed "the average cost is Rs 75,000" reads as fabricated; "we typically quote Rs 60,000 to Rs 90,000 for this scope" is first-party fact and needs no source.
- Show the arithmetic on any cost breakdown and say what the range depends on.
...
- Delete vague attribution. "Research shows", "studies indicate", "experts agree" and "data suggests" must either name the specific source in the same sentence or be rewritten without the claim.
- Our own pricing is different: keep those breakdowns, but make the first-party framing explicit. "The average cost is Rs 75,000" reads as an invented market statistic; "we typically quote Rs 60,000 to Rs 90,000" is first-party fact. Rewrite any bare figure into the second form, show the arithmetic, and say what the range depends on.
...
## CONTEXT YOU MUST APPLY WHEN SCORING
This is TheBrandFriend's own company blog, not a newspaper. Two consequences:

1. **The agency's own pricing is first-party information and needs no citation.**
   Rupee ranges for our services, our hourly rates, our delivery timelines and
   our cost breakdowns are things the company knows about itself. Presenting
   them as our ranges is correct and is the whole point of the article. Do NOT
   score these as fabricated. Only score a pricing figure as fabricated if it
   is presented as an industry-wide statistic or market average rather than as
   our own quoted range.

2. **Mentioning TheBrandFriend, its services and its process is expected.**
   A comparison table that includes us is normal for a company blog and is not
   a credibility problem. Do not penalise the article for self-reference unless
   it becomes a sales pitch that crowds out the useful content.

Fabrication means: invented third-party statistics, made-up research findings,
fake client names or case-study results, claimed awards, a specific volume of
past work ("we have built 200+ sites"), or two figures that contradict each
other. It does not mean "a number without a footnote".
...
- noFabrication: apply the definition above. First-party pricing is fine. Invented third-party statistics are not.
