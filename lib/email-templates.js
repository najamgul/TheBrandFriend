...
<body style="margin:0;padding:0;background:#f7f7f7;font-family:-apple-system,BlinkMacSystemFont,'Segoe UI',Roboto,sans-serif;">
  <div style="max-width:560px;margin:0 auto;padding:40px 20px;">
    ...
    <div style="background:#ffffff;padding:32px 28px;border-radius:0 0 6px 6px;">
      ...
      <p style="margin:0 0 16px;font-size:15px;line-height:1.7;color:#444;">
        In the meantime, you can browse our <a href="https://www.thebrandfriend.com/designs/" style="color:#2563eb;text-decoration:none;">Design Library</a> for inspiration.
      </p>
    ...
    <div style="text-align:center;padding:20px;font-size:11px;color:#aaa;">
      ...
      <p style="margin:4px 0 0;"><a href="https://www.thebrandfriend.com" style="color:#888;text-decoration:none;">thebrandfriend.com</a></p>
    </div>
  </div>
</body>
</html>`,
